...
# YOUR CUSTOM PACKAGE SOURCES
declare -a custom_packages
# EXAMPLE:
# custom_packages+=("<name>|<git/svn>|<url>")
...
# Packages
declare -a base_libs
base_libs+=("efl|git|$git_baseurl/core/efl.git")
base_libs+=("evas_generic_loaders|git|$git_baseurl/core/evas_generic_loaders.git")
base_libs+=("elementary|git|$git_baseurl/core/elementary.git")
declare -a base_apps
base_apps+=("enlightenment|git|$git_baseurl/core/enlightenment.git")
base_apps+=("entrance|git|$git_baseurl/misc/entrance.git")
base_apps+=("terminology|git|$git_baseurl/apps/terminology.git")
declare -a base_modules
base_modules+=("alarm|git|$git_baseurl/enlightenment/modules/alarm.git")
base_modules+=("comp-scale|git|$git_baseurl/enlightenment/modules/comp-scale.git")
base_modules+=("cpu|git|$git_baseurl/enlightenment/modules/cpu.git")
base_modules+=("diskio|git|$git_baseurl/enlightenment/modules/diskio.git")
base_modules+=("empris|git|$git_baseurl/enlightenment/modules/empris.git")
base_modules+=("engage|git|$git_baseurl/enlightenment/modules/engage.git")
base_modules+=("eweather|git|$git_baseurl/enlightenment/modules/eweather.git")
base_modules+=("forecasts|git|$git_baseurl/enlightenment/modules/forecasts.git")
base_modules+=("mail|git|$git_baseurl/enlightenment/modules/mail.git")
base_modules+=("moon|git|$git_baseurl/enlightenment/modules/moon.git")
base_modules+=("mpdule|git|$git_baseurl/enlightenment/modules/mpdule.git")
base_modules+=("net|git|$git_baseurl/enlightenment/modules/net.git")
base_modules+=("news|git|$git_baseurl/enlightenment/modules/news.git")
base_modules+=("penguins|git|$git_baseurl/enlightenment/modules/penguins.git")
base_modules+=("photo|git|$git_baseurl/enlightenment/modules/photo.git")
base_modules+=("places|git|$git_baseurl/enlightenment/modules/places.git")
base_modules+=("tclock|git|$git_baseurl/enlightenment/modules/tclock.git")
declare -a extra_games
extra_games+=("elemines|git|$git_baseurl/games/elemines.git")
...
packages_full="$base_libs_list$base_apps_list$base_modules_list$extra_games_list$custom_packages_list"

# Basic Dependencies
deps_bin="automake byacc g++ gcc git libtool pkg-config svn"
...
conf_files="$conf_files /etc/easy_e17.conf $HOME/.config/easy_e17/easy_e17.conf $HOME/.easy_e17.conf $PWD/.easy_e17.conf" # EASY_E17 COMPATIBILITY!
...
animation="star"
online_source="http://omicron.homeip.net/projects/easy_efl/easy_efl.sh"	# URL of latest stable release
...
function package_find ()
{
	...
	found=0
	for package in ${base_libs[*]} ${base_apps[*]} ${base_modules[*]} ${extra_games[*]} ${custom_packages[*]}
	{
		package_name=`echo "$package" | cut -d'|' -f1`
		...
		case $1 in
			0)
				if [ "$os" == "not supported" ]; then
					...
					echo "                             - basic (efl+enlightenment)"
					echo "                             - half  (efl+enlightenment+e-modules)"
					echo "                             - full  (efl+enlightenment+e-modules+apps)"
					echo
...
# FIXME[morlenxus]: Currently unused
...
function check_script_version ()
{
	...
	remote_version=`wget $online_source -q -U "easy_efl.sh/$version" -O - | grep -m 2 -o [0-9]\.[0-9]\.[0-9] | sort -n | head -n 1`
...
if [ ! "$action"  == "srcupdate" ]; then
	...
	if [ "$only" ]; then
		echo
		echo "- matching packages with internal package lists (basic/full)..."
